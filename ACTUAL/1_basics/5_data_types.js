...
const infigity = Infinity;
const nInfigity = -Infinity;


console.log(typeof infigity);
console.log(typeof nInfigity);
console.log('--------------------');
...
const backSlash = '아이브\\코팩';
console.log(backSlash);
const smallQutoation = '아이브\'코팩';
console.log(smallQutoation);

const iveWonYoung2 = `아이브ㅑ '" //////
장원영`;
...
/**
 * static typing -> 변수를 선언할때 어떤 타입의 변수를 선얼할지 명시를 한다.
 *                  C
