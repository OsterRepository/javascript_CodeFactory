 ...
 *클래스 강의룰 끝낸 기념 문제
 *
 * 1) Country 클래스를 나라 이름과 나라에 해당되는 아이돌 그룹정보를 리스트로 들고있다.(name 프로퍼티, idolGroups 프로퍼티)
 * 2) IdolGroup 클래스는 아이돌 그룹 이름 정보와 멤버 정보를 리스트로 들고있다.(name 프로퍼티, members 프로퍼티)
 ...
 *    추가로 dance() 함수를 실행하면 ${이름}이 춤을 춥니다. 라는 스트링을 반환해 준다.
 */
